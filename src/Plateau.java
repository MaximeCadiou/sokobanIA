...
public class Plateau extends Observable {
    ...
    /** Appelle le LevelLoader pour le niveau donn�
     * @param niveau Le numero du niveau � charger
     */
    ...
    /**Rappel� par le level loadeur le fichier parcouru
     *Instancie nbLignes et nbColonnes pour �viter des cases superflues selon le tableau charg�
     */
    ...
    /** Renvoie la partie associ�e
     */
    public Partie getPartie() {
        return p;
    }

    /**Renvoie le nombre de pas effectu�s dans ce plateau
     */
    public int getNbPas() {
        return nbPas;
    }
    ...
    /** Renvoie la case situ�e sur la ligne ligne et la colonne colonne
    ...
    /** Renvoie le booleen instanci� dans testVictoire()
     */
    ...
    public void bougerPerso(int direction) {
        ...
        switch(direction) {
            ...
            case KeyEvent.VK_DOWN : //on descends
                descendre();
                break;
            case KeyEvent.VK_LEFT ://on va � gauche
                aGauche();
                break;
        }//switch
        setChanged();
