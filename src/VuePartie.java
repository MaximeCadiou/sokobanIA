...
/** Cette classe permet de visualiser des �l�ments tels que le niveau courant
 * ou encore le nombre de pas effectu�s.
 * Elle permet �galement de refaire les niveaux compl�t�s
 */
